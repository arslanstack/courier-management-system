        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form id="search_form" action="{{url('admin/vehicle-posts')}}" method="GET" enctype="multipart/form-data">
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search_query" placeholder="Search by Zip, State, City, or Company Name" value="{{ old('search_query', $searchParams['search_query'] ?? '') }}">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <p>Showing {{ $vehiclePosts->firstItem() }} to {{ $vehiclePosts->lastItem() }} of {{ $vehiclePosts->total() }} entries</p>
                        </div>
                        <div class="col-md-3 text-right">
                            {{ $vehiclePosts->links('pagination::bootstrap-4') }}
                        </div>
                    </div>
                </div>
            </div>
