								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ map_company_type($company->company_type) }}</label>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->mail_address_2 ?? 'N/A' }}</label>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->motor_carrier_no ?? 'N/A' }}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->intrastate_no ?? 'N/A' }}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ date_formated($company->created_at) }}</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->insurance_company ?? 'N/A' }}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">
												...
												<a href="{{ url('/public/uploads/insurance_declarations/' . $company->insurance_declaration ) }}" target="_blank">{{ $company->insurance_declaration }}</a>
												@else
												N/A
												@endif
											</label>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->alert_email_1 ?? 'N/A'}}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->alert_email_2 ?? 'N/A'}}</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->alert_freight == 1 ? 'On' : 'Off' }}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->alert_vehicle == 1 ? 'On' : 'Off' }}</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->alert_rpf == 1 ? 'On' : 'Off' }}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->alert_driver == 1 ? 'On' : 'Off' }}</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->company_phone ?? 'N/A'}} </label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->company_mobile ?? 'N/A' }}</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{ $company->account_type == 0 ? 'Exchange' : 'Premium'}} </label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{$company->card_number ?  substr($company->card_number, 0,4) . '************' : 'N/A'}}</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{$company->card_number ?  '***' : 'N/A'}}</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row">
											...
											<label class="col-8 col-form-label">{{$company->card_number ? $company->expiry_month . '/' .$company->expiry_year : 'N/A'}}</label>
										</div>
									</div>
								</div>
								<div class="row">
