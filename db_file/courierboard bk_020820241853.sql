...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2024 at 03:53 PM
...
CREATE TABLE `rfps` (
  ...
  `start_coordinates` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `rfp_bids`
--

INSERT INTO `rfp_bids` (`id`, `rfp_id`, `user_id`, `company_id`, `amount`, `terms`, `status`, `contact_name`, `contact_phone`, `contact_email`, `created_at`, `updated_at`) VALUES
(1, 1, 17, 18, '2000', 'In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before the final copy is available.', 0, 'Joshua', '+15613451289', 'jasper@gmail.com', '2024-08-02 08:40:04', '2024-08-02 08:40:04');
...
('wJQaZTMbBhNcIJIdiHNp9HgjIieJtSJTHepsCA2q', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:128.0) Gecko/20100101 Firefox/128.0', '', 1722606783);
